...
import { cutomerSignUpMutation } from "../../mutation/mutation";
...
class CustomerSignup extends Component {
  ...
  handleCustomerAdded = e => {
    ...
    if (valid === "") {
      ...
      this.props.signupCustomer(data, this.props.history);
      // this.setState({
      //   ...this.state,
      //   ownerSignedUp: true
      // });
  ...
  doGraphSignUp = event => {
    ...
    this.props
      ...
      .then(res => {
        if (res.data.customerSignUp.status === 200) {
          localStorage.setItem("customerToken", res.data.customerSignUp.token);
          this.props.history.push("/home");
        } else if (res.data.customerSignUp.status === 404) {
          alert("Traveler already exists, please login !!");
          // this.props.history.push('/home');
        }
      });
  };
                    ...
                    <div className="panel-body">
                      <div id="createAccountFields" className="">
                        ...
                        <button
                          ...
                          id="form-submit"
                          onClick={this.doGraphSignUp.bind(this)}
                        >
                          Sign Me Up
                        </button>
                      </div>
...
export default connect(
  mapStateToProps,
  { signupCustomer }
)(withRouter(CustomerSignup));*/

export default compose(
  graphql(cutomerSignUpMutation, { name: "cutomerSignUpMutation" })
)(CustomerSignup);
